      ...
      <div class="w-full grid grid-cols-2 gap-16">
        <div class="flex flex-col items-start ">
          ...
          <div class="w-3/5 mx-auto flex items-center justify-around mt-4">
            <!--  Telegram  -->
            <a href="https://t.me/gp_saffron" target="_blank" class="w-14 h-14 logo-rotate text-[#7A7A7A] hover:text-[#F6F6F6] rounded-full bg-[#F4F4F4] grid place-items-center hover:bg-[#2AABEE] transition-all duration-300 cursor-pointer">
            ...
            <!--  Instagram  -->
            <a href="https://www.instagram.com/gp_saffron" target="_blank" class="w-14 h-14 logo-rotate text-[#7A7A7A] hover:text-[#F6F6F6] rounded-full bg-[#F4F4F4] grid place-items-center hover:bg-[#000100] transition-all duration-300 cursor-pointer">
              <svg class="w-5" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <!--  Youtube  -->
            <a href="https://www.youtube.com/@gpsaffron" target="_blank" class="w-14 h-14 logo-rotate text-[#7A7A7A] hover:text-[#F6F6F6] rounded-full bg-[#F4F4F4] grid place-items-center hover:bg-[#FF0302] transition-all duration-300 cursor-pointer">
            ...
            <!--  Whatsapp  -->
            <a href="https://wa.me/+989912937952" target="_blank" class="w-14 h-14 logo-rotate text-[#7A7A7A] hover:text-[#F6F6F6] rounded-full bg-[#F4F4F4] grid place-items-center hover:bg-[#00D95F] transition-all duration-300 cursor-pointer">
              <svg class="w-5" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
