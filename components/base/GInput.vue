<template>
  <div class="w-full relative flex items-center mb-4">
    ...
    <button v-if="type === 'password'" class="absolute left-4 opacity-30" type="button">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" v-if="showPassword" @click="showPassword = false">
      ...
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" v-else @click="showPassword = true">
