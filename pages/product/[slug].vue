<template>
  <div class="mt-12 flex flex-col space-y-8 mx-4 lg:mx-0">
    ...
    <section class="flex flex-col items-center space-y-8 lg:space-y-0 lg:items-start lg:flex-row">
      ...
      <div class="flex-1 flex flex-col lg:order-2 mx-4">
      ...
      <div class="bg-bgWhite p-6 rounded-2xl w-full lg:w-1/4 lg:order-3 drop-shadow-lg">
        ...
        <hr class="my-4">
        <div  class="border-2 border-dgKala p-2 px-4 w-full rounded-lg flex flex-col items-end text-sm text-dgKala space-y-2 animate-pulse">
    ...
    <section >
      ...
      <div id="info" class="mt-8 mx-4 lg:mx-0" ref="info">
      ...
      <div id="comments" ref="comments" class="mx-4 lg:mx-0">
        <div class="w-max flex items-center space-x-2 space-x-reverse border-b-2 border-brandOrange pb-2 pl-12">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" opacity="0.4">
