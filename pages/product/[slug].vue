<template>
  <div class="mt-12 flex flex-col space-y-8 mx-4 lg:mx-0">
    ...
    <section class="flex flex-col items-center space-y-8 lg:space-y-0 lg:items-start lg:flex-row">
      ...
      <div class="flex-1 flex flex-col lg:flex-row lg:order-2 mx-4">
      ...
      <div class="bg-bgWhite p-6 rounded-2xl w-full lg:w-1/4 lg:order-3 drop-shadow-lg">
    ...
    <section class="mx-4 lg:mx-0">
      ...
      <div id="comments" ref="comments">
        ...
        <div class="w-full flex flex-col lg:flex-row mt-8">
          ...
          <div class="flex-1 pr-10 border-r-4 border-brandOrange/50 mt-8 lg:mt-0">
