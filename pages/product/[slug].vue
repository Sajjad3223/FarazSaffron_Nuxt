    ...
    <section>
      <div class="w-full sticky top-0 bg-bgWhite z-10 pt-8 ">
        <div class="flex space-x-12 space-x-reverse">
          <a href="#info" class="relative after:bg-brandOrange after:absolute after:-bottom-2 after:left-0 after:right-0 after:h-2 after:rounded-t-full">مشخصات</a>
          <a href="#comments">نظرات</a>
          <a href="#related">کالاهای مرتبط</a>
        </div>
