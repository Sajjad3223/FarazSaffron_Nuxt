  ...
  <div class="mt-12 flex flex-col space-y-12">
    <div>
      <ul class="flex items-center space-x-4 space-x-reverse">
        ...
        <li class="opacity-40 pointer-events-none select-none">/</li>
        <li class="text-primary font-medium">
        ...
        <li class="opacity-40 pointer-events-none select-none">/</li>
        <li class="font-light">زعفران نگین</li>
      </ul>
    </div>
    <section class="flex flex-col items-center space-y-8 lg:space-y-0 lg:items-start lg:flex-row">

      <div class="flex-1 flex lg:order-2 mx-4 flex-col">
        <h3 class="text-2xl font-bold">زعفران نگین جی پی زعفران - 4.608 گرم</h3>
        <hr class="my-2">
        <ul class="flex flex-col space-y-3 list-disc pr-6 mt-4">
          <li>
            <span class="font-light">شکل ماده غذایی:</span>
            <strong class="mr-2">نگین</strong>
          </li>
          <li>
            <span class="font-light">پروانه بهداشت:</span>
            <strong class="mr-2">دارد</strong>
          </li>
        </ul>

        <div class="bg-danger/40 text-black p-4 rounded-xl mt-32 animate-pulse">
        ...
        <div class="flex items-center justify-around mt-14 opacity-70">
      ...
      <div class="bg-bgWhite p-6 rounded-2xl w-1/2 lg:w-1/4 lg:order-3 drop-shadow-lg">
    ...
    <section>
      <div class="w-full sticky top-0 bg-bgWhite z-10 pt-8 ">
        <div class="flex space-x-12 space-x-reverse">
          ...
          <a href="#catalog" :class="[{'activeTab':visitingTab == 'catalog'}]">دریافت کاتالوگ</a>
          <a href="#related" :class="[{'activeTab':visitingTab == 'related'}]">کالاهای مرتبط</a>
        </div>
        <hr class="mt-2 border-brandOrange/50">
      </div>
      <div id="info" class="mt-8" ref="info">
      ...
      <div id="comments" ref="comments">
        ...
        <div class="w-full flex mt-8">
          <div class="flex flex-col items-start space-y-3 w-1/5 ml-10">
                ...
                <div class="flex justify-between items-start">
                  <div class="flex flex-col space-y-3">
                    <div class="flex items-center">
                      ...
                      <div class="rounded-lg border-2 border-brandOrange flex space-x-2 space-x-reverse px-2 py-1 items-center opacity-80">
                        ...
                        <span class="font-bold text-xs text-brandOrange">4.4</span>
                      </div>
                    </div>
                    <div class="flex items-center space-x-4 space-x-reverse">
                      ...
                      <span class="bg-[#FFF1DA] rounded-full py-1 px-4 text-brandOrange text-xs">
                        خریدار
                      </span>
                    </div>
                  </div>
