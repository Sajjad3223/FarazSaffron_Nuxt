            ...
            <td class="px-4 py-3">
              <div class="flex items-center space-x-4 text-sm">
                <NuxtLink :to="`/admin/orders/${o.id}`" title="مشاهده جزئیات" v-if="o.itemsCount > 0"
                          class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-300 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                >
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
