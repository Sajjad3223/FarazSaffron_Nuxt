  ...
  <div>
    ...
    <div class="flex flex-col w-full gap-5" v-if="data">
      <div class="grid grid-cols-3 gap-5">
        <div class="bg-white border rounded-2xl text-2xl p-12 min-h-[300px] flex flex-col space-y-5 justify-center">
      ...
      <div class="grid grid-cols-2 gap-5">
        <div class="bg-white border rounded-2xl min-h-[400px] flex p-10 flex-col space-y-4">
        ...
        <div class="bg-white border rounded-2xl min-h-[400px] p-10 flex flex-col">
