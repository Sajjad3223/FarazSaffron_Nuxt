<template>
  <div>
    ...
    <base-f-divider :logo-divider="false" title="داشبورد" />

    <div class="flex flex-col w-full gap-5" v-if="data">
      <div class="grid grid-cols-3 gap-5">
        <div class="bg-white border rounded-2xl text-2xl p-12 2xl:min-h-[300px] flex flex-col space-y-5 justify-center">
          <div class="flex 2xl:text-4xl font-light gap-2">
            ...
            <sup class="text-xs">(ماه جاری)</sup>
          </div>
      ...
      <div class="grid grid-cols-2 gap-5">
        <div class="bg-white border rounded-2xl 2xl:min-h-[400px] flex p-10 flex-col space-y-4">
          ...
          <div class="flex flex-col w-full space-y-5">
            ...
            <div class="flex items-center justify-between">
              ...
              <NuxtLink to="/admin/orders/inProgress">
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M7.75 9.5L4.25 6L7.75 2.5" stroke="#3787FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </NuxtLink>
        ...
        <div class="bg-white border rounded-2xl 2xl:min-h-[400px] p-10 flex flex-col">
          ...
          <div class="flex flex-col my-5 w-full" v-if="data.lowQuantityItems.length > 0 && itemsSection == 'lowQuantity'"> <!-- TODO show products -->
            محصولات در حال اتمام موجودی
          </div>
          <div class="flex flex-col my-5 w-full" v-else-if="data.unavailableItems.length > 0 && itemsSection == 'unavailable'"> <!-- TODO show products -->
            محصولات بدون موجودی
          </div>
