<template>
  <div>
    ...
    <div class="min-h-[300px] flex items-center justify-center" v-else>
      <GLoadingProgress class="!-translate-y-[0%]" />
    </div>
...
import type {AuthenticatorFilterData} from "~/models/certificate/authenticatorDto";
import {DeleteAuthenticator, GetAllAuthenticators} from "~/services/certificate.service";
