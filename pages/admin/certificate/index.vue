<template>
  <div>
    ...
    <base-g-modal title="ویرایش شناسنامه" v-model="showEditCertificateModal">
      <admin-properties-edit-c-property :property="selectedCertificate"
                                        @propertyEdited="showEditCertificateModal = false,getData()"/>
    </base-g-modal>
...
const deleteCertificate = (certificateId: number) => {
  toast.showToast("آیا از حذف شناسنامه اطمینان دارید؟", ToastType.warning, 0, false, async () => {
