          ...
          <template v-for="c in categories">
            ...
            <tr class="text-gray-700 " v-for="ch in c.children">
              ...
              <td class="-translate-x-8 px-4 py-3">
                <div class="flex items-center text-sm">
                  <div
                      class="relative before:absolute before:-right-5 before:opacity-60 before:w-2 before:h-2 before:bg-black before:dark:bg-white before:rounded-full flex items-center">
...
const deleteCategory = (id: number) => {
  toast.showToast("با حذف این دسته بندی همه محصولات آن نیز حذف خواهند شد، آیا از حذف اطمینان دارید؟", ToastType.warning, 0, false,
      async () => {
