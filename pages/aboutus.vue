  ...
  <div class="flex flex-col items-center mt-12">
    ...
    <div class="mt-12 p-8 bg-[#F8F8F8] rounded-2xl">
      ...
      <div class="mt-16 flex flex-col items-center">
        ...
        <a href="" class="flex items-center gap-6 text-white bg-brandOrange px-8 py-1 rounded-xl font-bold text-lg mt-6" style="box-shadow: 0 10px 25px 0 #F1482333">
