...
<div class="container mx-auto mt-24 flex flex-col" dir="ltr">
  ...
  <div class="grid grid-cols-8 gap-8 place-items-center font-light text-sm ">
    ...
    <div class="font-bold font-[montserrat]">Primary</div>
    <div>
      <button :class="[`rounded-xl px-4 py-2 primary transition-colors duration-200`]">
        Primary
      </button>
    </div>
    <div>
      <button class="rounded-xl px-4 py-2 secondary transition-colors duration-200">
        Secondary
      </button>
    </div>
    <div>
      <button class="rounded-xl px-4 py-2 success transition-colors duration-200">
        Success
      </button>
    </div>
    <div>
    ...
    <div>
      <button class="rounded-xl px-4 py-2 disabled ">
        Disabled
      </button>
    </div>
    ...
    <div>
      <button class="rounded-xl px-4 py-2 primary-stroke transition-colors duration-200">
        Primary
      </button>
    </div>
    <div>
      <button class="rounded-xl px-4 py-2 secondary-stroke transition-colors duration-200">
        Secondary
      </button>
    </div><div>
    ...
    <div>
      <button class="rounded-xl px-4 py-2 disabled-stroke ">
        Disabled
      </button>
    </div>
    ...
    <div>
      <button class="rounded-xl px-4 py-2 primary-white transition-all duration-200">
        Primary
      </button>
    </div>
    <div>
      <button class="rounded-xl px-4 py-2 secondary-white transition-all duration-200">
        Secondary
      </button>
    </div>
    <div>
    ...
    <div>
      <button class="rounded-xl px-4 py-2 disabled-white">
        Disabled
      </button>
    </div>
  ...
  <div class="w-1/3 mx-auto grid grid-cols-3 gap-8 place-content-center">
    <div class="gap-2 flex items-center">
      <input v-model="check1" type="checkbox" name="unchecked" id="unchecked" class="form-checkbox checkbox-style rounded-sm outline-brandOrange focus:ring-brandOrange stroke-brandOrange border-2 w-4 h-4 border-[#CACACA] text-brandOrange cursor-pointer">
      <label for="unchecked" class="cursor-pointer font-[Montserrat] text-sm">{{ check1 ? 'Checked' : 'UnChecked' }}</label>
    </div>
    <div class="gap-2 flex items-center">
      <input v-model="check2" type="checkbox" name="Checked" id="Checked" class="form-checkbox checkbox-style rounded-sm outline-brandOrange focus:ring-brandOrange stroke-brandOrange border-2 w-4 h-4 border-[#CACACA] text-brandOrange cursor-pointer">
      <label for="Checked" class="cursor-pointer font-[Montserrat] text-sm">{{ check2 ? 'Checked' : 'UnChecked' }}</label>
    </div>
    <div class="gap-2 flex items-center">
      <input type="checkbox" name="Disabled" id="Disabled" class="form-checkbox border-transparent rounded-sm text-[#E9E9E9] w-4 h-4 relative flex items-center after:bg-[#B3B3B3] after:h-1 after:rounded-[1px] after:absolute after:inset-x-0.5 cursor-not-allowed" indeterminate disabled>
  ...
  <div class="w-1/3 mx-auto grid grid-cols-3 gap-8 place-content-center mt-8">
    <div class="w-max relative toggle flex items-center gap-2">
      <input v-model="toggle1" type="checkbox" name="toggle" id="toggle" class="form-checkbox opacity-0 peer absolute inset-0">
    ...
    <div class="w-max relative toggle flex items-center gap-2">
      <input v-model="toggle2" type="checkbox" name="toggle-on" id="toggle-on" class="form-checkbox opacity-0 peer absolute inset-0">
    ...
    <div class="w-max relative toggle flex items-center gap-2">
      <input type="checkbox" name="toggle-disabled" id="toggle-disabled" class="form-checkbox opacity-0 peer absolute inset-0" disabled>
  ...
  <div class="grid grid-cols-3 gap-4 place-items-center mb-12">
    ...
    <div class="w-full relative flex items-center">
      <input v-model="textRtl" type="text" :class="['peer rtl input',{'input-error':errorValidationRtl},{'input-valid':successValidationRtl}]" required>
...
.input{
  ...
  & + label{
    @apply absolute left-4 text-sm font-light font-[montserrat] text-opacity-70 px-2 bg-white transition-all duration-200 rounded-full pointer-events-none;
  ...
  &:focus,&:valid{
    ...
    & + label{
      @apply text-brandOrange font-medium -translate-y-full top-2 text-xs;
    }
  }
