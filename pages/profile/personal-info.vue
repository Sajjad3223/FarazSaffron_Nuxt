<template>
  <div>
    ...
    <div v-if="!accountStore.initLoading" class="grid grid-cols-1 lg:grid-cols-2 p-4 bg-bgWhite dark:bg-gray-800 dark:text-white dark:border-gray-600 border rounded-xl lg:m-4">
