  ...
  <div>
    ...
    <div class="mt-6">
      <ul v-if="tab == 'delivered'" class="flex flex-col w-full">
        <li class="flex flex-col p-4 py-6 rounded-xl border bg-bgWhite dark:bg-gray-800 dark:text-white dark:border-gray-600">
      ...
      <div v-if="tab == 'returned'" class="bg-bgWhite border dark:bg-gray-800 dark:text-white dark:border-gray-600 rounded-xl p-4 flex flex-col items-center justify-center space-y-4 my-12">
